...
// GENERAL URL
// ===================================================
const NetliinksUrl = 'https://backend2.netliinks.com:443/rest/entities/';
// ===================================================
// TOOLS
// ===================================================
...
export const getToken = async (mail, password) => {
    const URL = 'https://backend2.netliinks.com:443/oauth/token';
    const ReqOptions = {
        method: 'POST',
...
export const getFile = async (fileUrl) => {
    const url = 'https://backend2.netliinks.com:443/rest/files?fileRef=';
    const requestOptions = {
        method: 'GET',
        headers: headers,
        redirect: 'follow'
...
export const setFile = async (file) => {
    const url = `https://backend2.netliinks.com:443/rest/files?name=${file.name}`;
    const requestOptions = {
        method: 'POST',
        headers: {
