...
export const exportVehiEgressPdf = async (ar: any) => {
    // @ts-ignore
...
export const exportVehiEgressCsv = (ar: any, start: any, end: any) => {
    let rows = [];
...
export const exportVehiEgressXls = (ar: any, start: any, end: any) => {
    let rows = [];
    for(let i=0; i < ar.length; i++){
      let note = ar[i]
      let noteCreationDateAndTime = note.creationDate.split('T');
