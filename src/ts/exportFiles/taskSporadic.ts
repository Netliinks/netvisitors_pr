export const exportSporadicPdf = (ar: any, start: any, end: any) => {
    // @ts-ignore
...
export const exportSporadicCsv =  (ar: any, start: any, end: any) => {
    let rows = [];
    for (let i = 0; i < ar.length; i++) {
        let sporadic = ar[i];
        // @ts-ignore
...
export const exportSporadicXls =  (ar: any, start: any, end: any) => {
    let rows = [];
    for (let i = 0; i < ar.length; i++) {
        let sporadic = ar[i];
        // @ts-ignore
...
const verifyUserType = (userType:any) => {
